  ...
  return (
    <div>
      <div className="prose">
        ...
        <p>
        Delta Lab is led by {" "}
        <a href="http://www.eleanorourke.com/" target="_blank" rel="noreferrer">
          Dr. Eleanor O&apos;Rourke
        </a>, {" "}
        <a href="https://egerber.mech.northwestern.edu/" target="_blank" rel="noreferrer">
          Dr. Liz Gerber
        </a>, {" "}
        <a href="http://matteasterday.com/" target="_blank" rel="noreferrer">
          Dr. Matt Easterday
        </a>, and {" "}
        <a href="http://haoqizhang.com/" target="_blank" rel="noreferrer">
          Dr. Haoqi Zhang
        </a>.
        </p>
        ...
        <p>
          <b>Visit Us</b>
          <br></br>
          <a href="https://goo.gl/maps/wcVLdnJun4NXX9z88" target="_blank" rel="noreferrer">
              Segal Design Institute, 3.230<br></br>
              2133 Sheridan Rd<br></br>
              Evanston, IL 60208<br></br>
          </a>
          <br></br>
          <a href="https://goo.gl/maps/AuieUx9sHzHqjrtD8" target="_blank" rel="noreferrer">
              Mudd Hall (Department of Computer Science), 3-542<br></br>
              2233 Tech Drive, Third Floor<br></br>
              Evanston, IL 60208<br></br>
          </a>
      </p>
